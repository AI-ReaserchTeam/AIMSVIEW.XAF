...
namespace AIMSVIEW.XAF.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater
{
	...
	public override void UpdateDatabaseAfterUpdateSchema()
	{
...
#if !RELEASE
		ApplicationUser sampleUser = ObjectSpace.FirstOrDefault<ApplicationUser>(user => user.UserName == "User");
		if (sampleUser == null)
		{
		...
		ApplicationUser userAdmin = ObjectSpace.FirstOrDefault<ApplicationUser>(user => user.UserName == "Abubakar Ibrahim");
		if (userAdmin == null)
		{
			userAdmin = ObjectSpace.CreateObject<ApplicationUser>();
			userAdmin.UserName = "Abubakar Ibrahim";
			// Set a password if the standard authentication type is used
			userAdmin.SetPassword("Sh@pson");
